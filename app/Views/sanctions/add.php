<div class="p-4 md:p-8">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600 text-sm md:text-base">Enregistrez une nouvelle sanction disciplinaire</p>
    </div>

    <!-- Formulaire -->
    <div class="bg-white rounded-xl shadow-lg p-6 md:p-8">
        <form method="POST" action="<?= url('sanctions/add') ?>" class="space-y-6">
            <?= csrf_field() ?>
            ...
            <div>
                ...
                <textarea id="motif"
                          ...
                          required
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent"
                          placeholder="D̩tails de la sanction..."></textarea>
            </div>
