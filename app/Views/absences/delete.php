    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-xl shadow-lg p-6 md:p-8">
            <div class="text-center mb-6">
                ...
                <p class="text-gray-600">Êtes-vous sûr de vouloir supprimer cette absence ?</p>
            </div>

            <div class="bg-gray-50 rounded-lg p-4 mb-6">
                <p class="font-semibold text-gray-800">Absence du <?= formatDate($absence['date_debut']) ?> au <?= formatDate($absence['date_fin']) ?></p>
                <?php if ($absence['motif']): ?>
                    <p class="text-sm text-gray-600 mt-1"><?= e($absence['motif']) ?></p>
                <?php endif; ?>
            </div>
