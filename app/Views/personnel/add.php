<div class="p-4 md:p-8">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600 text-sm md:text-base">Enregistrez un nouveau membre du personnel</p>
    </div>

    <!-- Formulaire -->
    <div class="bg-white rounded-xl shadow-lg p-6 md:p-8">
        <form method="POST" action="<?= url('personnel/add') ?>" class="space-y-6" enctype="multipart/form-data">
            <?= csrf_field() ?>
            ...
            <!-- Ligne 4 : Téléphone, Diplome, Poste -->
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <!-- Téléphone -->
                <div>
                ...
                <div>
                    <label for="poste" class="block text-sm font-medium text-gray-700 mb-2">
                        <i class="fas fa-briefcase mr-2 text-gray-500"></i>Poste *
                    </label>
                    <input type="text" 
                           id="poste" 
                           name="poste" 
            ...
            <!-- Ligne 5 : Date d'embauche, Service, Statut -->
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <!-- Date d'embauche -->
                <div>
                ...
                <div>
                    <label for="service" class="block text-sm font-medium text-gray-700 mb-2">
                        <i class="fas fa-building mr-2 text-gray-500"></i>Service
                    </label>
                    <input type="text" 
                           id="service" 
                           name="service"
