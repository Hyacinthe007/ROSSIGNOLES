    ...
    <div class="max-w-3xl mx-auto">
        <div class="mb-8 flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600">Créez un message type avec des variables personnalisables.</p>
            </div>
        ...
        <form action="<?= url('notifications/modeles/add') ?><?= !empty($_GET['iframe']) ? '?iframe=1' : '' ?>" method="POST" class="space-y-6 animate-fade-in">
                ...
                <div class="p-6 md:p-8 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="nom" required placeholder="Ex: Rappel Absence"
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="sujet" required placeholder="Ex: Absence injustifiée de votre enfant"
                            class="w-full px-5 py-3 rounded-2xl border border-gray-200 focus:ring-4 focus:ring-indigo-50/50 focus:border-indigo-500 outline-none transition-all">
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="contenu" required rows="8" placeholder="Écrivez votre message type ici..."
                            class="w-full px-5 py-3 rounded-2xl border border-gray-200 focus:ring-4 focus:ring-indigo-50/50 focus:border-indigo-500 outline-none transition-all resize-none"></textarea>
                    </div>
                </div>
