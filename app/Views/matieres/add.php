...
<div class="p-4 md:p-8">
    <div class="mb-4 flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600">Cr̩ez une nouvelle mati̬re</p>
        </div>
        ...
        <form method="POST" action="<?= url('matieres/add') ?><?= isset($_GET['iframe']) ? '?iframe=1' : '' ?>" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label for="code" class="block text-sm font-medium text-gray-700 mb-2">
                        ...
                        <span class="text-xs text-gray-500 ml-2">(G̩n̩r̩ automatiquement si vide)</span>
                    </label>
                    <input type="text"
                           id="code"
                           name="code"
            ...
            <div>
                ...
                <textarea id="description"
                          ...
                          rows="4"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          placeholder="Description de la mati̬re..."></textarea>
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-4 pt-6 mt-8 border-t">
                ...
                <button type="submit"
                    ...
                    <span>Enregistrer la mati̬re</span>
                </button>
            </div>
        </form>
    </div>
