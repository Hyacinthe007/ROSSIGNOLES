<div class="p-4 md:p-8">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600 text-sm md:text-base">Modifier les informations du type de frais</p>
    </div>

    <!-- Formulaire -->
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-2xl">
        <form method="POST" action="<?= url('finance/types-frais/edit/' . $typeFrais['id']) ?>">
            <?= csrf_field() ?>
            ...
            <div class="mb-6">
                ...
                <textarea id="description" name="description" rows="3"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          placeholder="Description détaillée du type de frais..."><?= e($typeFrais['description'] ?? '') ?></textarea>
            </div>
