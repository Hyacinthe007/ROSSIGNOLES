    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-xl shadow-lg p-6 md:p-8">
            <div class="text-center mb-6">
                ...
                <p class="text-gray-600">Êtes-vous sûr de vouloir supprimer ce parent ?</p>
            </div>

            <div class="bg-gray-50 rounded-lg p-4 mb-6">
                <p class="font-semibold text-gray-800"><?= e($parent['prenom'] . ' ' . $parent['nom']) ?></p>
                <p class="text-sm text-gray-600"><?= e($parent['type_parent']) ?></p>
            </div>

            <form method="POST" action="<?= url('parents/delete/' . $parent['id']) ?>" class="flex flex-col sm:flex-row gap-4">
                <?= csrf_field() ?>
                <button type="submit" 
